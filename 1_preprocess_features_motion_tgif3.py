...
if __name__ == '__main__':
    ...
    parser.add_argument('--question_type', default='transition', choices=['frameqa', 'count', 'transition', 'action', 'none'], type=str)
    # output
    parser.add_argument('--out', dest='outfile',
                        help='output filepath',
                        default="data/{}/{}_{}_feat_swin_large_all.h5", type=str)
    ...
    if args.dataset == 'sutd-qa':
        ...
        args.annotation_file = 'datasets/TGIF-QA/csv/Train_{}_question.csv'
        args.video_dir = 'datasets/TGIF-QA/gifs'
        args.outfile = 'data/{}/{}/{}_{}_{}_feat_resnetxt_train.h5'
