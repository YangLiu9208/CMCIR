...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='msvd-qa', choices=['sutd-qa','tgif-qa', 'msrvtt-qa', 'msvd-qa'], type=str)
    ...
    parser.add_argument('--output_pt', type=str, default='data/{}/{}_{}_question_keybert_v2.pt')
    parser.add_argument('--output_subject_pt', type=str, default='data/{}/{}_{}_questions_subject_keybert_v3.pt')
    parser.add_argument('--output_relation_pt', type=str, default='data/{}/{}_{}_questions_relation_keybert_v3.pt')
    parser.add_argument('--output_object_pt', type=str, default='data/{}/{}_{}_questions_object_keybert_v3.pt')
    parser.add_argument('--vocab_json', type=str, default='data/{}/{}_vocab_keybert_v3.json')
    parser.add_argument('--vocab_subject_json', type=str, default='data/{}/{}_vocab_subject_keybert_v3.json')
    parser.add_argument('--vocab_relation_json', type=str, default='data/{}/{}_vocab_relation_keybert_v3.json')
    parser.add_argument('--vocab_object_json', type=str, default='data/{}/{}_vocab_object_keybert_v3.json')
    ...
    if args.dataset == 'sutd-qa':
        ...
        if not os.path.exists('data/{}'.format(args.dataset)):
            os.makedirs('data/{}'.format(args.dataset))
        msvd_qa.process_questions_oie_keybert2(args)