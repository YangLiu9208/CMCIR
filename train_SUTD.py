...
from validate_sutd_finegrained import validate
import model.VLCIR_sutd_GAFN_bertv3 as VLCIR
...
def train_oie(cfg):
    ...
    train_loader = VideoQADataLoader_oie_bert_opendended(**train_loader_kwargs) #,collate_fn=lambda x: x
...
def main():
    ...
    parser.add_argument('--cfg', dest='cfg_file', help='optional config file', default='configs/sutd-qa_dict_st_swin_bert.yml', type=str)
    ...
    if cfg.dataset.name == 'tgif-qa':
        ...
        cfg.dataset.vocab_json = '{}_vocab_oie_bert3.json'
        ...
        cfg.dataset.train_question_pt = '{}_train_questions_bert3.pt'
        ...
        cfg.dataset.val_question_pt = '{}_test_questions_bert3.pt'
        ...
        # cfg.dataset.vocab_json = '{}_vocab_bert2.json'
        # cfg.dataset.vocab_subject_json = '{}_vocab_bert2.json'
        # cfg.dataset.vocab_relation_json = '{}_vocab_bert2.json'
        # cfg.dataset.vocab_object_json = '{}_vocab_bert2.json'        
        # cfg.dataset.train_question_pt = '{}_train_questions_bert2.pt'
        # cfg.dataset.train_question_subject_pt = '{}_train_questions_subject_bert2.pt'
        # cfg.dataset.train_question_relation_pt = '{}_train_questions_relation_bert2.pt'
        # cfg.dataset.train_question_object_pt = '{}_train_questions_object_bert2.pt'
        # cfg.dataset.val_question_pt = '{}_test_questions_bert2.pt'
        # cfg.dataset.val_question_subject_pt = '{}_test_questions_subject_bert2.pt'
        # cfg.dataset.val_question_relation_pt = '{}_test_questions_relation_bert2.pt'
        # cfg.dataset.val_question_object_pt = '{}_test_questions_object_bert2.pt'

        # cfg.dataset.vocab_json = '{}_vocabv2_keybert_v2.json'
        # cfg.dataset.vocab_subject_json = '{}_vocab_subjectv2_keybert_v2.json'
        # cfg.dataset.vocab_relation_json = '{}_vocab_relationv2_keybert_v2.json'
        # cfg.dataset.vocab_object_json = '{}_vocab_objectv2_keybert_v2.json'        
        # cfg.dataset.train_question_pt = '{}_train_questionsv2_keybert_v2.pt'
        # cfg.dataset.train_question_subject_pt = '{}_train_questions_subjectv2_keybert_v2.pt'
        # cfg.dataset.train_question_relation_pt = '{}_train_questions_relationv2_keybert_v2.pt'
        # cfg.dataset.train_question_object_pt = '{}_train_questions_objectv2_keybert_v2.pt'
        # cfg.dataset.val_question_pt = '{}_test_questionsv2_keybert_v2.pt'
        # cfg.dataset.val_question_subject_pt = '{}_test_questions_subjectv2_keybert_v2.pt'
        # cfg.dataset.val_question_relation_pt = '{}_test_questions_relationv2_keybert_v2.pt'
        # cfg.dataset.val_question_object_pt = '{}_test_questions_objectv2_keybert_v2.pt'
        cfg.dataset.train_question_pt = os.path.join(cfg.dataset.data_dir,
