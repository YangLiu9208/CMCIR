...
class InputUnitLinguistic_Transformer(nn.Module):
    def __init__(self, vocab_size, wordvec_dim=300, module_dim=512):
        ...
        self.TransformerEncoder_text = TransformerEncoder(embed_dim=module_dim, pos_flag='sincos',pos_dropout=0.0,num_heads=8,attn_dropout=0.0,res_dropout=0.1,activ_dropout=0.1,activation='gelu',num_layers=8)
...
class InputUnitVisual_GST_Transformer(nn.Module):
    def __init__(self, motion_dim, appearance_dim, module_dim=512):
        ...
        self.QATransformer =  TransformerEncoder(embed_dim=module_dim, pos_flag='sincos',pos_dropout=0.0,num_heads=8,attn_dropout=0.0,res_dropout=0.1,activ_dropout=0.1,activation='gelu',num_layers=3)
        self.QMTransformer =  TransformerEncoder(embed_dim=module_dim, pos_flag='sincos',pos_dropout=0.0,num_heads=8,attn_dropout=0.0,res_dropout=0.1,activ_dropout=0.1,activation='gelu',num_layers=3)
        self.VIATransformer =  TransformerEncoder(embed_dim=module_dim, pos_flag='sincos',pos_dropout=0.0,num_heads=8,attn_dropout=0.0,res_dropout=0.1,activ_dropout=0.1,activation='gelu',num_layers=3)
        self.VIMTransformer =  TransformerEncoder(embed_dim=module_dim, pos_flag='sincos',pos_dropout=0.0,num_heads=8,attn_dropout=0.0,res_dropout=0.1,activ_dropout=0.1,activation='gelu',num_layers=3)
        self.module_dim = module_dim
        for m in self.modules():
