...
class InputUnitVisual_GST_Transformer_GAFN(nn.Module):
    ...
    def forward(self, appearance_video_feat, motion_video_feat, question_embedding,question_embedding_do, appearance_dict, motion_dict):
        ...
        # visual_embedding_m = self.VIMTransformer(question_visual_m,visual_embedding_motion.permute(1,0,2))
        # visual_embedding_m_do = self.VIMTransformer(question_visual_m_do,visual_embedding_motion_vlad.permute(1,0,2))
        # visual_embedding_a = self.VIATransformer(question_visual_a,torch.mean(visual_embedding_appearance.permute(1,2,0,3), 1))
        # visual_embedding_a_do = self.VIATransformer(question_visual_a_do,torch.mean(visual_embedding_appearance_vlad.permute(1,2,0,3), 1))
