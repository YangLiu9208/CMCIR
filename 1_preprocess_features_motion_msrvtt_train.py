...
if __name__ == '__main__':
    ...
    # dataset info
    parser.add_argument('--dataset', default='msrvtt-qa', choices=['sutd-qa', 'tgif-qa', 'msvd-qa', 'msrvtt-qa'], type=str)
    parser.add_argument('--question_type', default='none', choices=['frameqa', 'count', 'transition', 'action', 'none'], type=str)
    # output
    parser.add_argument('--out', dest='outfile',
                        help='output filepath',
                        default="data/{}/{}_{}_resnext24_feat_train.h5", type=str)
    ...
    # network params
    parser.add_argument('--model', default='resnext101', choices=['resnet101', 'resnext101', 'S3D', 'ViViT', 'Swin'], type=str)
    ...
    if args.dataset == 'sutd-qa':
        ...
        args.annotation_file = 'datasets/MSRVTT-QA/train_qa.json'
        args.video_dir = 'datasets/MSRVTT-QA/video/'
        video_paths = msrvtt_qa.load_video_paths_train(args)
        random.shuffle(video_paths)
        # load model
        if args.model == 'resnet101':
            model = build_resnet()
        ...
        args.annotation_file = 'datasets/MSVD-QA/train_qa.json'
        args.video_dir = 'datasets/MSVD-QA/YouTubeClips/video/'
