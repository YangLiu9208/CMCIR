    ...
    with h5py.File(outfile, 'w') as fd:
        ...
        for i, (video_path, video_id) in enumerate(video_ids):
            ...
            if args.feature_type == 'appearance':
                ...
                if feat_dset is None:
                    A,B,C, D ,E= clip_torch.shape
                    feat_dset = fd.create_dataset('raw_motion_clips', (dataset_size, A,B,C,D,E),
                                                  dtype=np.float32)
                    video_ids_dset = fd.create_dataset('ids', shape=(dataset_size,), dtype=np.int)

            i1 = i0 + 1
            feat_dset[i0:i1] = clip_torch
...
if __name__ == '__main__':
    ...
    parser.add_argument('--gpu_id', type=int, default=1, help='specify which gpu will be used')
    # dataset info
    ...
    parser.add_argument('--out', dest='outfile',
                        ...
                        default="data/{}/{}_{}_raw_clips_v2.h5", type=str)
    ...
    # network params
    parser.add_argument('--model', default='ViViT', choices=['resnet101', 'resnext101', 'S3D', 'ViViT'], type=str)
