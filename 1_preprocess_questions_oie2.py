...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_pt', type=str, default='data/{}/{}_{}_questions_bert3.pt')
    parser.add_argument('--output_subject_pt', type=str, default='data/{}/{}_{}_questions_subject_oie_bert3.pt')
    parser.add_argument('--output_relation_pt', type=str, default='data/{}/{}_{}_questions_relation_oie_bert3.pt')
    parser.add_argument('--output_object_pt', type=str, default='data/{}/{}_{}_questions_object_oie_bert3.pt')
    parser.add_argument('--vocab_json', type=str, default='data/{}/{}_vocab_oie_bert3.json')
    parser.add_argument('--vocab_subject_json', type=str, default='data/{}/{}_vocab_subject_oie_bert3.json')
    parser.add_argument('--vocab_relation_json', type=str, default='data/{}/{}_vocab_relation_oie_bert3.json')
    parser.add_argument('--vocab_object_json', type=str, default='data/{}/{}_vocab_object_oie_bert3.json')
