...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_pt', type=str, default='data/TGIF-QA/{}/tgif-qa_{}_{}_questions_keybert_v5.pt')
    parser.add_argument('--output_subject_pt', type=str, default='data/TGIF-QA/{}/tgif-qa_{}_{}_questions_subject_keybert_v5.pt')
    parser.add_argument('--output_relation_pt', type=str, default='data/TGIF-QA/{}/tgif-qa_{}_{}_questions_relation_keybert_v5.pt')
    parser.add_argument('--output_object_pt', type=str, default='data/TGIF-QA/{}/tgif-qa_{}_{}_questions_object_keybert_v5.pt')
    parser.add_argument('--vocab_json', type=str, default='data/TGIF-QA/{}/tgif-qa_{}_vocab_keybert_v5.json')
    parser.add_argument('--vocab_subject_json', type=str, default='data/TGIF-QA/{}/tgif-qa_{}_vocab_subject_keybert_v5.json')
    parser.add_argument('--vocab_relation_json', type=str, default='data/TGIF-QA/{}/tgif-qa_{}_vocab_relation_keybert_v5.json')
    parser.add_argument('--vocab_object_json', type=str, default='data/TGIF-QA/{}/tgif-qa_{}_vocab_object_keybert_v5.json')
    parser.add_argument('--mode', default='train',choices=['train', 'val', 'test'])
    parser.add_argument('--question_type', choices=['frameqa', 'action', 'transition', 'count', 'none'], default='count')
    ...
    if args.dataset == 'sutd-qa':
        ...
        if args.question_type in ['frameqa', 'count']:
            tgif_qa.process_questions_openended_oie_bert3(args)
        else:
