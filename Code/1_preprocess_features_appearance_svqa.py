...
from preprocess.datautils import svqa
...
if __name__ == '__main__':
    ...
    # dataset info
    parser.add_argument('--dataset', default='msvd-qa', choices=['sutd-qa', 'tgif-qa', 'msvd-qa', 'msrvtt-qa','svqa'], type=str)
    ...
    # network params
    parser.add_argument('--model', default='Swin', choices=['resnet101', 'resnext101','ViViT', 'Swin'], type=str)
    ...
    if args.dataset == 'sutd-qa':
        ...
        args.annotation_file = 'datasets/SVQA/questions.json' #TODO
        args.video_dir = 'datasets/SVQA/useVideo/' #TODO
