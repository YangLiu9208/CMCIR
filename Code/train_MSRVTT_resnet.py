...
import model.VLCIR_msrvtt_bert as VLCIR
from utils import todevice
...
def main():
    ...
    parser.add_argument('--cfg', dest='cfg_file', help='optional config file', default='configs/msrvtt_qa_resnet24.yml', type=str)
    ...
    if cfg.dataset.name == 'tgif-qa':
        ...
        cfg.dataset.vocab_json = '{}_vocab_keybert2.json'
        cfg.dataset.vocab_subject_json = '{}_vocab_subject_keybert2.json'
        cfg.dataset.vocab_relation_json = '{}_vocab_relation_keybert2.json'
        cfg.dataset.vocab_object_json = '{}_vocab_object_keybert2.json'        
        cfg.dataset.train_question_pt = '{}_train_question_keybert2.pt'
        cfg.dataset.train_question_subject_pt = '{}_train_questions_subject_keybert2.pt'
        cfg.dataset.train_question_relation_pt = '{}_train_questions_relation_keybert2.pt'
        cfg.dataset.train_question_object_pt = '{}_train_questions_object_keybert2.pt'
        cfg.dataset.val_question_pt = '{}_test_question_keybert2.pt'
        cfg.dataset.val_question_subject_pt = '{}_test_questions_subject_keybert2.pt'
        cfg.dataset.val_question_relation_pt = '{}_test_questions_relation_keybert2.pt'
        cfg.dataset.val_question_object_pt = '{}_test_questions_object_keybert2.pt'
        cfg.dataset.train_question_pt = os.path.join(cfg.dataset.data_dir,
