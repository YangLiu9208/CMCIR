...
from DataLoader import VideoQADataLoader_oie_bert
from utils import todevice
from validate import validate

import model.VLCIR_VLAD_bert_mulitchoice as VLCIR
from utils import todevice
...
def train_oie(cfg):
    ...
    train_loader = VideoQADataLoader_oie_bert(**train_loader_kwargs)
    ...
    if cfg.val.flag:
        ...
        val_loader = VideoQADataLoader_oie_bert(**val_loader_kwargs)
    ...
    optimizer = optim.Adam(model.parameters(), cfg.train.lr, betas=(0.9, 0.999), eps=1e-08, weight_decay=0, amsgrad=False)
    #optimizer = optim.SGD(model.parameters(), cfg.train.lr, momentum=9e-1, weight_decay=5e-4)
    ...
    for epoch in range(start_epoch, cfg.train.max_epochs):
        ...
        if cfg.val.flag:
            ...
            valid_acc, all_preds, gts, v_ids, q_ids= validate(cfg, model, val_loader, device, write_preds=True)
...
def main():
    ...
    parser.add_argument('--cfg', dest='cfg_file', help='optional config file', default='configs/tgif_qa_transition_swin.yml', type=str)
    ...
    if cfg.dataset.name == 'tgif-qa':
        # cfg.dataset.vocab_json = '{}_{}_vocabv2.json'
        # cfg.dataset.vocab_subject_json = '{}_{}_vocab_subjectv2.json'
        # cfg.dataset.vocab_relation_json = '{}_{}_vocab_relationv2.json'
        # cfg.dataset.vocab_object_json = '{}_{}_vocab_objectv2.json'        
        # cfg.dataset.train_question_pt = '{}_{}_train_questionsv2.pt'
        # cfg.dataset.train_question_subject_pt = '{}_{}_train_questions_subjectv2.pt'
        # cfg.dataset.train_question_relation_pt = '{}_{}_train_questions_relationv2.pt'
        # cfg.dataset.train_question_object_pt = '{}_{}_train_questions_objectv2.pt'
        # cfg.dataset.val_question_pt = '{}_{}_test_questionsv2.pt'
        # cfg.dataset.val_question_subject_pt = '{}_{}_test_questions_subjectv2.pt'
        # cfg.dataset.val_question_relation_pt = '{}_{}_test_questions_relationv2.pt'
        # cfg.dataset.val_question_object_pt = '{}_{}_test_questions_objectv2.pt'
        cfg.dataset.vocab_json = '{}_{}_vocab_keybert_v4.json'
        cfg.dataset.vocab_subject_json = '{}_{}_vocab_subject_keybert_v4.json'
        cfg.dataset.vocab_relation_json = '{}_{}_vocab_relation_keybert_v4.json'
        cfg.dataset.vocab_object_json = '{}_{}_vocab_object_keybert_v4.json'        
        cfg.dataset.train_question_pt = '{}_{}_train_questions_keybert_v4.pt'
        cfg.dataset.train_question_subject_pt = '{}_{}_train_questions_subject_keybert_v4.pt'
        cfg.dataset.train_question_relation_pt = '{}_{}_train_questions_relation_keybert_v4.pt'
        cfg.dataset.train_question_object_pt = '{}_{}_train_questions_object_keybert_v4.pt'
        cfg.dataset.val_question_pt = '{}_{}_test_questions_keybert_v4.pt'
        cfg.dataset.val_question_subject_pt = '{}_{}_test_questions_subject_keybert_v4.pt'
        cfg.dataset.val_question_relation_pt = '{}_{}_test_questions_relation_keybert_v4.pt'
        cfg.dataset.val_question_object_pt = '{}_{}_test_questions_object_keybert_v4.pt'
        ...
        cfg.dataset.train_question_pt = '{}_train_questionsv2.pt'
        cfg.dataset.train_question_subject_pt = '{}_train_questions_subjectv2.pt'
        cfg.dataset.train_question_relation_pt = '{}_train_questions_relationv2.pt'
        cfg.dataset.train_question_object_pt = '{}_train_questions_objectv2.pt'
        cfg.dataset.val_question_pt = '{}_test_questionsv2.pt'
        cfg.dataset.val_question_subject_pt = '{}_test_questions_subjectv2.pt'
        cfg.dataset.val_question_relation_pt = '{}_test_questions_relationv2.pt'
        cfg.dataset.val_question_object_pt = '{}_test_questions_objectv2.pt'
        cfg.dataset.train_question_pt = os.path.join(cfg.dataset.data_dir,
