...
import model.VLCIR_VLAD_bert as VLCIR
from utils import todevice
...
def train_oie(cfg):
    ...
    optimizer = optim.Adam(model.parameters(), cfg.train.lr, betas=(0.9, 0.999), eps=1e-08, weight_decay=5e-4, amsgrad=False)
...
def main():
    ...
    parser.add_argument('--cfg', dest='cfg_file', help='optional config file', default='configs/tgif_qa_count_resnet.yml', type=str)
